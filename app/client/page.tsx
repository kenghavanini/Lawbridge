...
export default function ClientHub() {
  ...
  const cards = [
    { title: 'Secure Client Access & Email Verify', desc: 'Enter your registered email to verify secure guest portal access and retrieve active matter keys.', href: '/client/access' },
    { title: 'Submit New Matter', desc: 'Configure multi-jurisdiction practice areas (USA, Canada, UK), urgency, and budget tiers.', href: '/client/submit' },
